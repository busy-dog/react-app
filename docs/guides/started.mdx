...
推荐使用 [VS Code](https://code.visualstudio.com/)、Cursor 进行开发，并安装以下插件：

- [ESLint](https://eslint.org/)
- [Prettier](https://prettier.io/)
- [MDX](https://github.com/mdx-js/mdx-analyzer)
- [i18n Ally](https://github.com/lokalise/i18n-ally)
- [React Developer Tools](https://react.dev/reference/devtools)
- [SCSS Formatter](https://github.com/sibiraj-s/vscode-scss-formatter)
- [EJS language support](https://github.com/Digitalbrainstem/ejs-grammar)
- [Browserslist](https://github.com/wspwebben/browserslist-highlight.git)
- [CSS Variable Autocomplete](https://github.com/vunguyentuan/vscode-css-variables)
